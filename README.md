...
Я веб-разработчик <img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30px">. С августа 2021 года я занимаюсь разработкой веб-приложений - фронтенд, бэк и немного devops. Всего в разработке уже более 6 лет.
- 🌱 Веду <a href="https://t.me/captain_galera">канал</a> по разработке и менторю ребят по направлениям фронтенд и бэкенд на Node.js! Даю советы новичкам по поиску первой работы в IT исходя из своего опыта преподавания и фриланса.
...
[![Numart LeetCode](https://leetcode-stats-six.vercel.app/?username=Numart)](https://leetcode.com/u/Numart/)
